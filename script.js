...
"about-hero-scroll": "إنزل للأسفل لتقرأ قصتنا",

"about-story-eyebrow": "حكايتنا",
"about-story-title": "لما الاسم بقى وعد",
"about-story-since": "تأسست 2020 · المهندسين ، مصر",
"about-story-p1": "أحمد عرابي الرسميه لغات فتحت أبوابها بفكرة بسيطة ما صغرتش أبداً: إن الطفل ممكن يكبر متجذر في هويته المصرية وفي نفس الوقت حاسس إنه في بيته وسط لغات العالم كله. سمينا المدرسة على اسم أحمد عرابي، الراجل اللي اتذكر مش بألقابه، لكن بصراحته وكرامته وهو بيقف لبلده. وده المعيار اللي بنحاسب نفسنا عليه.",
...
"about-principal-title": "مدير مدرسة، أحمد عرابي الرسميه لغات",
