...
const translations = {
    ...
    en: {
        ...
        "primary-sub1-desc": "Science, Math, Languages and More",
        "primary-sub2-title": "Primary 2",
        "primary-sub2-desc": "Arabic, Math, English and More",
        "primary-sub3-title": "Primary 3",
        "primary-sub3-desc": "Arabic, Math, English and More",
        "primary-sub4-title": "Primary 4",
        "primary-sub4-desc": "Arabic, Math, English , Science , Soacial Studies And More",
        "primary-sub5-title": "Primary 5",
        "primary-sub5-desc": "Arabic, Math, English , Science , Soacial Studies And More",
        "primary-sub6-title": "Primary 6",
        "primary-sub6-desc": "Arabic, Math, English , Science , Soacial Studies And More",
...
"about-cta-btn": "Contact Us",
    ...
    ar: {
        ...
        "primary-hl1-desc": "علوم، رياضيات، لغات، ودراسات اجتماعية.",
        ...
        "primary-sub1-desc": "اللغه العربيه, اللغه الانجليزيه, الرياضيات",
        "primary-sub2-title": "ابتدائي 2 ",
        "primary-sub2-desc": "اللغه العربيه, اللغه الانجليزيه, الرياضيات",
        "primary-sub3-title": "ابتدائي 3",
        "primary-sub3-desc": "اللغه العربيه, اللغه الانجليزيه, الرياضيات",
        "primary-sub4-title": "ابتدائي 4",
        "primary-sub4-desc": "اللغه العربيه, اللغه الانجليزيه, الرياضيات, العلوم, الدراسات الاجتماعيه و المزيد",
        "primary-sub5-title": "ابتدائي 5",
        "primary-sub5-desc": "اللغه العربيه, اللغه الانجليزيه, الرياضيات, العلوم, الدراسات الاجتماعيه و المزيد",
        "primary-sub6-title": "ابتدائي 6",
        "primary-sub6-desc": " اللغه العربيه, اللغه الانجليزيه, الرياضيات, العلوم, الدراسات الاجتماعيه و المزيد",
        ...
        "prep-sub1-desc": "اللغة العربية، الرياضيات، الإنجليزية، العلوم، الدراسات الاجتماعية والمزيد",
        "prep-sub2-title": "إعدادي 2 ",
        "prep-sub2-desc": "اللغة العربية، الرياضيات، الإنجليزية، العلوم، الدراسات الاجتماعية والمزيد",
        "prep-sub3-title": "إعدادي 3",
        "prep-sub3-desc" :  "اللغة العربية، الرياضيات، الإنجليزية، العلوم، الدراسات الاجتماعية والمزيد",
